        ...
        <body>
            ...
            <div class="page" id="register">
                ...
                <form method="post" action="">
                    ...
                    <div class="input-group">        
                        ...
                        <input type="text" id="number" name="number" placeholder="contact" required/><br/>
                    </div>
            ...
            <?php 
                if(isset($_POST['regButton'])){
                    ...
                    $c_contact = $_POST['number'];
                    
                    $sql_e = "SELECT * FROM user WHERE email='$c_email'";
                    $res_e = $object->query($sql_e) or die('error');
                    if(mysqli_num_rows($res_e) > 0){
  	                     echo "<script>alert('Mail already exists!')</script>";
                    }
                        
                    $sql = "INSERT INTO user VALUES (
                        '','$c_name', '$c_email',  '$c_pass', '$c_contact'
                    )";

                    $object->query($sql) or die('Ne mogu da se ubace podaci u user');
                    echo "Uspesno ubaceni podaci 2 u user! <br/>";
